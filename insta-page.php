...
/*
Template name: Промо страницы Инстаграм
*/
...
<div class="content bg-gray">
	...
	<div class="container promo-content">
		...
		<?php if (($postCounter%2) != 0) : ?>
			...
			<div class="row" style="position: relative;">
				...
				<div class="col-md-4">
					...
					<div style="padding:106.25% 0 0 0;position:relative;">
						<iframe src="https://player.vimeo.com/video/<?php echo $promo['promoNumberVimeo']; ?>?title=0&byline=0&portrait=0" style="position:absolute;top:0;right:0;width:100%;height:100%;" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
					</div>
					<script src="https://player.vimeo.com/api/player.js"></script>
				</div>
				<div class="col-md-8">
					<h3 class="mobs-off text-uppercase"><?php echo $promo['promoHeader']; ?></h3>
					<div class="font-light mx-4">
						<div class="mt-5 mobs-off"></div>
						<?php echo $promo['promoDescription']; ?>
					</div>
				</div>
			</div>
		...
		<?php endif ?>
			...
			<div class="row mt-5 mx-3 font-light">
				<?php $mores = $promo['_more']; ?>
				<?php foreach ($mores as $more) : ?>
					<div class="col-md mb-3">
						<p class="font-light text-center"><?php echo $more['moreTitle']; ?></p>
						<div style="padding:106.25% 0 0 0;position:relative;">
			...
			<?php $pluses = $promo['_plus']; ?>
			<?php if (isset($pluses)): ?>
			<div class="row mt-5 mx-3 font-light">
				<p class="text-center"><?php echo $promo['plusTitle']; ?></p>
				<?php foreach ($pluses as $plus) : ?>
					<div class="col-md mb-3">
						<div style="padding:106.25% 0 0 0;position:relative;">
							<iframe src="https://player.vimeo.com/video/<?php echo $plus['plusNumberVimeo']; ?>?title=0&byline=0&portrait=0" style="position:absolute;top:0;right:0;width:100%;height:100%;" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
						</div>
						<script src="https://player.vimeo.com/api/player.js"></script>
					</div>
				<?php endforeach ?>
